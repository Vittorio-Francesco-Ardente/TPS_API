...
[![Scope](https://img.shields.io/badge/Focus-Architettura%2C%20Funzionalit%C3%A0%2C%20Performance-0ea5e9)](#obiettivi-del-progetto)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-Tempo%20%7C%20Latenza%20%7C%20Throughput%20%7C%20Efficienza-22c55e)](#benchmark)
[![Docs](https://img.shields.io/badge/Docs-📄%20in%20docs%2F-blueviolet)](./docs/)
[![Team](https://img.shields.io/badge/Team-5%20studenti-ef4444)](#ruoli)
...
- [Tecnologie analizzate](#tecnologie-analizzate)
  ...
  - [Webhooks](#webhooks)
  - [MQTT](#mqtt)
- [Architettura e Struttura del repository](#architettura-e-struttura-del-repository)
- [Benchmark](#benchmark)
  - [Metriche misurate](#metriche-misurate)
  - [Metodologia](#metodologia)
  - [Riproducibilità e ambiente](#riproducibilità-e-ambiente)
- [Possibili applicazioni](#possibili-applicazioni)
- [Confronto rapido (feature matrix)](#confronto-rapido-feature-matrix)
- [Esempi minimi](#esempi-minimi)
- [Ruoli](#ruoli)
...
Note di accuratezza:
- Le descrizioni su formati, trasporti e modelli sono allineate alle specifiche ufficiali e alla pratica corrente.
- Alcune funzionalità (es. GraphQL subscriptions) non sono standardizzate in una singola specifica di trasporto: l’implementazione varia (WebSocket, SSE, ecc.).
- I grafici di esempio sono segnaposto: sostituiscili con i risultati reali generati dai vostri test in docs/.
